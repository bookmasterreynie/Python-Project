...
Run "install dependencies" then delete. It only needs to be used once. Once dependencies are installed, to run the launcher, simply double-click the file called Launcher
